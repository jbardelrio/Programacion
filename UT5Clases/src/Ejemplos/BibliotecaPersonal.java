...
public class BibliotecaPersonal {
	...
	public void añadirLibro(String nombre, String autor, String isbn) {
		...
		num_libros++;
		System.out.println("El libro ha sido aÃ±adido correctamente.");
	}
	...
	public void borrarLibro() {
		...
		try {
			...
			System.err
					.println("Error: Debe introducir un valor numérico comprendido"
	...
	private int mostrarMenu() {
		...
		System.out.println("4. Borrar libro desordenado");
